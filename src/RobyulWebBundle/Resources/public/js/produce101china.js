...
var csv = "produce101china.v10.csv";
...
// Get data
d3.csv("/bundles/robyulweb/csv/"+csv, parseLine, function (err, data) {
...
function getImageSource(d) {
    return "/bundles/robyulweb/images/produce101china/" + d.name.replace(/ /g, "").split("/")[0] + ".png";
}
